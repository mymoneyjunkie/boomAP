  ...
  async (req, res, next) => {
    try {
      ...
      if (!error.isEmpty()) {
        ...
        const response2 = await axios.request(
          insertUrl("music/insert/artist.php", "post", { name: name })
        );
        const data2 = response2.data;
  ...
  async (req, res, next) => {
    try {
      ...
      if (!error.isEmpty()) {
        ...
        const response2 = await axios.request(
          insertUrl("music/update/artist.php", "post", { name: name, id: id })
        );
        const data2 = response2.data;
  ...
  async (req, res, next) => {
    ...
    try {
      ...
      if (!cid && typeof cid == 'number') {
        ...
        const response = await axios.request(
          insertUrl("music/update/artist.php", "post", { 'id': cid, 'name': name })
        )
